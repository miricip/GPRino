...
prt='COM13'                                       #serial virtual port created  by Arduino

save_data = input("Save data on HDD? y/n: ")
velocity_index = int(input("Insert prop. meadia index 1-Air, 2-Ice, 3-Dry sand, 4-Dry soil (Granite), 5-Limestone, 6-Asphalt, 7-Concrete, 8-Moist soil,  9-Wet soil (Silt), 10-Saturated sand (Clay), 11-Sweet water, 12-Salt water: "))
...
cable_velocity = 150000000                        #electromagnetic wave velocity in cable and antennas
