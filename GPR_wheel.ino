...
const word offset = 9;                    //offset cables + antennas in no. of resolution cells
...
void setup()
{
  ...
  min_depth = -offset * resolution;  	//offset cables + antennas
